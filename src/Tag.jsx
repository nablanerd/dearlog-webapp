...
class Tag extends React.Component {
    ...
    async handleSubmit(event) {  
      ...
      {    
        ...
        //todo object log        
        const tag = await this.store.updateTag(
          id,
        {
          name,
          description
      ...
      this.props.notify_success("tag updated")
...

    {
      ...
      this.props.notify_success("tag added")
    }
     }
  ...
  onDelete (e)
  {
    ...
    this.store.deleteTag(this.state.id)

    this.props.notify_success("tag deleted")
...
load(idParam)
{
  ...
  this.store.getTag(idParam)
  .then(data => {

    console.log("data", data);

  let {id, name, description, createdAt, updatedAt} = data;
